...
insert into "user" (email, name, password, city, admin) values ('aatu@example.com', 'Aatu A. Admin', '$2a$12$OCm372a0jVx3aiyVFF/20ebBPYDuiNbF68trrjXnS.JCdeRaeMkNq', 'Kittilä', true);
...
insert into "user" (email, name, password, city) values ('erkki@example.com', 'Erkki Esimerkki', '$2a$12$MPNlgEYiL8E642/aoifUI.zFjZ.tZqn6z6M9Q9d4LESLbj6/fOcs6', 'Kontiolahti');
insert into "user" (email, name, password, city) values ('tiina@example.com', 'Tiina Terävä', '$2a$12$35UNCdILjFVkrtQ6EZxQI.iP657igOG9afCWIGIFiA2yX4vw5V7n6', 'Lempäälä');
